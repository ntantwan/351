...
//	gl.depthFunc(gl.LESS);
  ...
  // Constructor for 4x4 matrix, defined in the 'cuon-matrix.js' library
  // supplied by your textbook.  (Chapter 3)
  
  // Initialize the matrix: see ../lib/cuon-matrix.js or its variants
...
//-----------------  DRAW STUFF!
  ...
  gl.drawArrays(gl.TRIANGLES,   // drawing primitive. (try gl.LINE_LOOP too!)
                0, 
                12);
  // says to WebGL: draw the vertices in currently-bound VBO,
