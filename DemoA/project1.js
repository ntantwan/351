...
//		--HINT: don't confuse 'getElementByID() and 'getElementById()
		...
		document.getElementById('CurPosDisplay').innerHTML= 
			'planet_pos_x= '+planet2x.toFixed(5);
		document.getElementById('CurPosDisplay2').innerHTML= 
			'planet_pos_y= '+planet2y.toFixed(5);
...
//  OpenGL's 'glGet()' becomes WebGL's 'getParameter()'
  ...
  g_modelMatrix.setTranslate(planet2x*1.05,planet2y*0.4,planet2z);
  g_modelMatrix.scale(0.25, 0.25, 0.25);
  g_modelMatrix.rotate(90, 1, 0, 0);
  g_modelMatrix.rotate(-18, 1, 1, 1);
  g_modelMatrix.rotate(g_angle03*0.5, 0, 0, 1); 
  gl.uniformMatrix4fv(g_modelMatLoc, false, g_modelMatrix.elements);
