, 1 , 0.4627 , 0.4745 , 0.6784 ,
		0 , -0.99 , -0.1 , 1 , 0.8588 , 0.7725 , 0.851 ,
		-0.6787 , -0.6787 , -0.2 , 1 , 0.9 , 0.7 , 1 ,
		...
		0.51 , 0 , 0.7 , 1 , 0.9 , 0.7 , 1 ,
		0.2545 , 0.2545 , 0.7999999999999999 , 1 , 0.4627 , 0.4745 , 0.6784 ,
		0.2545 , -0.2545 , 0.7999999999999999 , 1 , 0.8588 , 0.7725 , 0.851 ,
		0.51 , 0 , 0.7 , 1 , 0.8588 , 0.7725 , 0.851 ,
		0.2545 , 0.2545 , 0.7999999999999999 , 1 , 0.8 , 0.8 , 1 ,
		0 , 0.51 , 0.7 , 1 , 0.5137 , 0.5725 , 0.6588 ,
		0 , 0.51 , 0.7 , 1 , 0.8588 , 0.7725 , 0.851 ,
		0.2545 , 0.2545 , 0.7999999999999999 , 1 , 0.9 , 0.7 , 1 ,
...
function DrawTetra() {
	gl.drawArrays(gl.TRIANGLES, 480,480);
}
...
function DrawStick() {
	gl.drawArrays(gl.TRIANGLES, 960,36);
}

function DrawPanels() {
	gl.drawArrays(gl.TRIANGLES, 996,36);
}
...
//  OpenGL's 'glGet()' becomes WebGL's 'getParameter()'
  ...
  g_modelMatrix.setTranslate(0,-0.04,-0.8);  // 'set' means DISCARD old matrix,
  ...
  g_modelMatrix.rotate(90, 1, 0, 0);  // Make new drawing axes that 
  g_modelMatrix.rotate(12, 1, 1, 1);  // Make new drawing axes that 
  g_modelMatrix.rotate(g_angle04, 0, 0, 1);  // Make new drawing axes that 
  ...
  //g_modelMatrix.setTranslate(-0.6,0.54,0);
  g_modelMatrix.setTranslate(planet2x*0.85,planet2y*0.4,planet2z);
  g_modelMatrix.scale(0.125, 0.125, 0.125);
  g_modelMatrix.rotate(90, 1, 0, 0);
  g_modelMatrix.rotate(-18, 1, 1, 1);
  g_modelMatrix.rotate(g_angle03b, 0, 0, 1); 
  gl.uniformMatrix4fv(g_modelMatLoc, false, g_modelMatrix.elements);
  ...
  g_modelMatrix.translate(0.05,-0.05,0.02)
  g_modelMatrix.rotate(g_angle01, 1, 0, 0); 
  gl.uniformMatrix4fv(g_modelMatLoc, false, g_modelMatrix.elements);
  DrawPanels()
  pushMatrix(g_modelMatrix);
  g_modelMatrix.rotate(180,0,0)
  g_modelMatrix.translate(-tube3,0,0)
  g_modelMatrix.rotate(g_angle01, 1, 0, 0); 
  g_modelMatrix.rotate(g_angle01, 1, 0, 0); 
  gl.uniformMatrix4fv(g_modelMatLoc, false, g_modelMatrix.elements);
  DrawPanels()
  g_modelMatrix.translate(0,tube4,0)
  g_modelMatrix.rotate(g_angle01, 1, 0, 0); 
  gl.uniformMatrix4fv(g_modelMatLoc, false, g_modelMatrix.elements);
  DrawPanels()
  g_modelMatrix = popMatrix();
  g_modelMatrix.translate(0,tube2,0)
  g_modelMatrix.rotate(g_angle01, 1, 0, 0); 
  gl.uniformMatrix4fv(g_modelMatLoc, false, g_modelMatrix.elements);
  DrawPanels()
...
var planet2speedfactor = 0.5

function keys(kev) {
	if (kev.code == "ArrowLeft") {
		planet2speedfactor = planet2speedfactor - 0.2;
	}
...
//   return newAngle;
  ...
  g_angle03b = g_angle03b + (g_angle03bRate * elapsed * planet2speedfactor) / 1000.0; // rate in degrees/sec
  g_angle04 = g_angle04 + (g_angle04Rate * elapsed) / 1000.0; // rate in degrees/sec

  xangle = xangle + (0.4*elapsed) / 1000
  yangle = yangle + (0.3*elapsed) / 1000
  zangle = zangle + (0.4*elapsed) / 1000
  
  planet2x = 0.8*Math.cos(xangle)
  planet2y = 0.6*Math.cos(yangle)
  planet2z = 0.6*Math.sin(zangle)
