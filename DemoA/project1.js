		0 , -0.91 , 0.3 , 1 , 0.8 , 0.8 , 1 ,
		0.75 , 0 , 0.5 , 1 , 0.8 , 0.8 , 1 ,
		...
		0 , -0.75 , 0.5 , 1 , 0.8 , 0.8 , 1 ,
		0.51 , 0 , 0.7 , 1 , 1 , 1 , 1 ,
		0.2545 , 0.2545 , 0.7999 , 1 , 0.8 , 0.8 , 1 ,
		0.2545 , -0.2545 , 0.7999 , 1 , 0.9 , 0.7 , 1 ,
		0.51 , 0 , 0.7 , 1 , 0.9 , 0.7 , 1 ,
		0.2545 , 0.2545 , 0.7999 , 1 , 1 , 1 , 1 ,
		0 , 0.51 , 0.7 , 1 , 1 , 1 , 1 ,
		0 , 0.51 , 0.7 , 1 , 0.9 , 0.7 , 1 ,
		0.2545 , 0.2545 , 0.7999 , 1 , 0.8 , 0.8 , 1 ,
		-0.2545 , 0.2545 , 0.7999 , 1 , 0.8 , 0.8 , 1 ,
...
//  OpenGL's 'glGet()' becomes WebGL's 'getParameter()'
  ...
  g_modelMatrix.setTranslate(0,0,0);  // 'set' means DISCARD old matrix,
  						// (drawing axes centered in CVV), and then make new
  						// drawing axes moved to the lower-left corner of CVV. 
  g_modelMatrix.scale(1,1,-1);							// convert to left-handed coord sys
  																				// to match WebGL display canvas.
  g_modelMatrix.scale(0.23, 0.23, 0.7);
  ...
  g_modelMatrix.rotate(g_angle03, 1, 1, 1);  // Make new drawing axes that
...
//   g_modelMatrix.translate(c30, -0.5, 0.0);  // 'set' means DISCARD old matrix,drawing axes moved to the lower-left
//   g_modelMatrix.scale(1,1,-1);							// convert to left-handed coord sys
//   g_modelMatrix.scale(0.1, 0.1, 0.1);// if you DON'T scale, tetra goes outside the CVV; clipped!
//   gl.uniformMatrix4fv(g_modelMatLoc, false, g_modelMatrix.elements);
//   DrawPart1()

//   g_modelMatrix.translate(-c30*20, 0, 0);  // 'set' means DISCARD old matrix,drawing axes moved to the lower-left
//   gl.uniformMatrix4fv(g_modelMatLoc, false, g_modelMatrix.elements);
//   DrawPart1()

//   g_modelMatrix.translate(c30*10, 0.5*10, -sq2*10);  // 'set' means DISCARD old matrix,drawing axes moved to the lower-left
//   gl.uniformMatrix4fv(g_modelMatLoc, false, g_modelMatrix.elements);
//   DrawPart1()
...
//   g_modelMatrix.setTranslate(-0.5,0.5, 0.0);  // 'set' means DISCARD old matrix,drawing axes moved to the lower-left
//   g_modelMatrix.scale(1,1,-1);							// convert to left-handed coord sys
//   g_modelMatrix.scale(0.2, 0.2, 0.2);// if you DON'T scale, tetra goes outside the CVV; clipped!
...
//   return newAngle;
  ...
  if(g_angle02 < 0.0 && g_angle02Rate < 0) g_angle02Rate = -g_angle02Rate;
  g_angle02 = g_angle02 + (g_angle02Rate * elapsed) / 200.0; // rate in degrees/sec

  g_angle03 = g_angle03 + (g_angle03Rate * elapsed) / 1000.0; // rate in degrees/sec
  g_angle04 = g_angle04 + (g_angle04Rate * elapsed) / 1000.0; // rate in degrees/sec
