...
function main() {
  ...
  // Create, init matrix whose values we will send to GPU to set a 'uniform':
  var modelMatrix = new Matrix4();
	
  // Start drawing
  var tick = function() {
    currentAngle = animate(currentAngle);  // Update the rotation angle
    draw(gl, n, currentAngle, modelMatrix, u_ModelMatrix, u_colrLoc);   
    // Draw the triangle
...
function draw(gl, n, currentAngle, modelMatrix, u_ModelMatrix, u_colrLoc) {
//==========================================================================
