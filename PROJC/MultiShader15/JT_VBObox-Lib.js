...
// Gouraud + Phong
  ...
  '  vec3 eyeDirection = normalize(vec3(u_eyePosWorld.xyz) - vec3(vertexPosition.xyz));\n' +
...
// b) Create VBO on GPU, fill it------------------------------------------------
  ...
  this.u_Lamp0Pos  = gl.getUniformLocation(this.shaderLoc, 	'u_LightPosition');
  this.u_Lamp0Amb  = gl.getUniformLocation(this.shaderLoc, 	'u_AmbientLight');
  this.u_Lamp0Diff = gl.getUniformLocation(this.shaderLoc, 	'u_LightColor');
  this.u_Lamp0Spec = gl.getUniformLocation(this.shaderLoc, 'u_SpecularLight');
...
VBObox0.prototype.adjust = function(vpa) {
//==============================================================================
...
// the GPU; and (if needed) update each attribute's stride and offset in VBO.
  ...
  gl.uniform3f(this.u_Lamp0Pos, 1, 2, 1, 1.0);
  gl.uniform3f(this.u_Lamp0Amb,  0.4, 0.4, 0.4);	
  gl.uniform3f(this.u_Lamp0Spec,  1, 1, 1);	


  this.ModelMat.setTranslate(0, 0, 2, 1);	 
  this.ModelMat.scale(0.8,0.8,0.8);
  ...
  this.mvpMatrix.setPerspective(40,vpa,1.0,1000.0);
  this.mvpMatrix.lookAt(cameraX,cameraY,cameraZ,
					lookX,lookY,lookZ,
          0,0,1);
  ...
  gl.uniform4f(this.u_eyePosWorld, cameraX,cameraY,cameraZ, 1);
...
function VBObox1() {
  ...
  var xymax	= 50.0;			// grid size; extends to cover +/-xymax in x and y.
   var xColr = new Float32Array([0.3, 1.0, 1.0]);	// bright yellow
   var yColr = new Float32Array([1.0, 0.2, 0.7]);	// bright green.
  ...
  VBObox1.prototype.adjust = function(vpa) {
  //==============================================================================
  // Update the GPU to newer, current values we now store for 'uniform' vars on 
  // the GPU; and (if needed) update each attribute's stride and offset in VBO.
    ...
    // Adjust values for our uniforms,
    this.ModelMat.setPerspective(40,vpa,1.0,1000.0);
   this.ModelMat.lookAt(cameraX,cameraY,cameraZ,
            lookX,lookY,lookZ,
            0,0,1);
...
//  'gl_FragColor = vec4(1.0, 1.0, 1.0, 1.0);\n' +
  '}\n';
    ...
    -0.3, -0.3, 0.0, 1.0,		1.0, 0.6, 0.9,  14.0,   // (bright green)
     0.3, -0.3, 0.0, 1.0,		0.3, 0.3, 1.0,  21.0,   // (bright blue)
     0.3,  0.3, 0.0, 1.0,   0.5, 0.1, 0.5,  18.0,   // (gray)
  ]);
...
VBObox2.prototype.adjust = function(vpa) {
//=============================================================================
// Update the GPU to newer, current values we now store for 'uniform' vars on 
...
// attribute's stride and offset in VBO.
  ...
  if(this.isReady()==false) {
	...
	// Adjust values for our uniforms;-------------------------------------------
  this.ModelMatrix.setTranslate(0, 0, 0.0); //Shift origin leftwards,
  this.ModelMatrix.scale(0.1, 0.1, 0.1); //Shift origin leftwards,
...
function VBObox3() {
  ...
  //==============================================================================
    ...
    this.vboContents = sl2;
    console.log(this.vboContents);
  
    this.vboVerts = sl2.length/7;						// # of vertices held in 'vboContents' array
    this.FSIZE = this.vboContents.BYTES_PER_ELEMENT;
                                  // bytes req'd by 1 vboContents array element;
                                  // (why? used to compute stride and offset 
                                  // in bytes for vertexAttribPointer() calls)
    ...
    console.log((this.vboFcount_a_Pos0 +     // check the size of each and
      this.vboFcount_a_Colr0) *   // every attribute in our VBO
      this.FSIZE);
  ...
  // the GPU; and (if needed) update each attribute's stride and offset in VBO.
    ...
    gl.uniform3f(this.u_Lamp0Diff, 1.0, 1.0, 1.0);	
    gl.uniform3f(this.u_Lamp0Pos, 1, 2, 1, 1.0);
    gl.uniform3f(this.u_Lamp0Amb,  0.4, 0.4, 0.4);	
    gl.uniform3f(this.u_Lamp0Spec,  1, 1, 1);	

    gl.uniform3f(this.u_Ke, 0.1, 0.1, 0.1);				// Ke emissive
    //gl.uniform3f(this.u_Ke, 0.5, 0.5, 0.5);				// Ke emissive
    gl.uniform3f(this.u_Ka, 0.8, 0.2, 0.2);				// Ka ambient
    gl.uniform3f(this.u_Kd, 0.1, 0.1, 0.8);				// Kd	diffuse
	  gl.uniform3f(this.u_Ks, 0.1, 0.1, 0.8);       // Ks	specular

    gl.uniform4f(this.u_eyePosWorld, cameraX,cameraY,cameraZ, 1);

  
    this.ModelMat.setTranslate(-2, 1.5, 0.5, 1);	 
    this.ModelMat.scale(0.8,0.8,0.8);
    this.ModelMat.rotate(g_angleNow0, 0, 0, 1);
    gl.uniformMatrix4fv(this.u_ModelMatLoc, false, this.ModelMat.elements);
    this.mvpMatrix.setPerspective(40,vpa,1.0,1000.0);
    ...
    this.normalMatrix.transpose();
    gl.uniformMatrix4fv(this.u_NormalMatrixLoc, false, this.normalMatrix.elements);
    gl.drawArrays(gl.TRIANGLE_STRIP, 0, 96);

    this.ModelMat.translate(0.4525 , 0.4525 , -0.6 );	
    this.ModelMat.rotate(angle1, -1, 0, 0);
    this.ModelMat.translate(-0.4525 , -0.4525 , 0.6 );	
    ...
    this.normalMatrix.transpose();
    gl.uniformMatrix4fv(this.u_NormalMatrixLoc, false, this.normalMatrix.elements);
    gl.drawArrays(gl.TRIANGLE_STRIP, 96*1, 96);
    
    this.ModelMat.translate(-0.6787 , -0.6787 , -0.2);	
    this.ModelMat.rotate(angle1, 1, 0, 0);
    this.ModelMat.translate(0.6787 , 0.6787 , 0.2 );	
    ...
    this.normalMatrix.transpose();
    gl.uniformMatrix4fv(this.u_NormalMatrixLoc, false, this.normalMatrix.elements);
    gl.drawArrays(gl.TRIANGLE_STRIP, 96*2, 96);
    ...
    this.normalMatrix.transpose();
    gl.uniformMatrix4fv(this.u_NormalMatrixLoc, false, this.normalMatrix.elements);
    gl.drawArrays(gl.TRIANGLE_STRIP, 96*3, 96);
    ...
    this.normalMatrix.transpose();
    gl.uniformMatrix4fv(this.u_NormalMatrixLoc, false, this.normalMatrix.elements);
    gl.drawArrays(gl.TRIANGLE_STRIP, 96*4, 96);
  ...
  // Gouraud + Blinn Phong
    ...
    // sphere from one triangle strip.
      ...
      this.vboContents = box;
    console.log(box);
    console.log(typeof box);
      this.vboVerts = box.length/7;						// # of vertices held in 'vboContents' array
      this.FSIZE = this.vboContents.BYTES_PER_ELEMENT;
                                    // bytes req'd by 1 vboContents array element;
                                    // (why? used to compute stride and offset 
                                    // in bytes for vertexAttribPointer() calls)
    ...
    // the GPU; and (if needed) update each attribute's stride and offset in VBO.
      ...
      gl.uniform3f(this.u_Lamp0Diff, 1.0, 1.0, 1.0);		// diffuse
      gl.uniform3f(this.u_Lamp0Pos, 1, 5, 1, 1.0);
      gl.uniform3f(this.u_Lamp0Amb,  0.4, 0.4, 0.4);	
      gl.uniform3f(this.u_Lamp0Spec,  1, 1, 1);	

      gl.uniform3f(this.u_Ke, 0.0, 0.0, 0.0);				// Ke emissive
      //gl.uniform3f(this.u_Ke, 0.5, 0.5, 0.5);				// Ke emissive
      gl.uniform3f(this.u_Ka, 0.8, 0.2, 0.8);				// Ka ambient
      gl.uniform3f(this.u_Kd, 0.0, 0.8, 0.2);				// Kd	diffuse
      gl.uniform3f(this.u_Ks, 0.1, 1.0, 0.1);       // Ks	specular
    
    //
    
    this.ModelMat.setTranslate(0,0,0);
    this.ModelMat.scale(1,1,1);
    this.ModelMat.translate(3,3,0);
    this.ModelMat.rotate(90,1,0,0);


    //this.ModelMat.scale(0.4,0.4,0.4);
    //this.ModelMat.translate(-5,1,-3);
    //g_modelMatrix.translate(keyMoveRight,keyMoveUp,0);
    ...
    //this.ModelMat.translate(0,boxY,0);
    this.ModelMat.rotate(g_angle02,-0.8125,0.2,0.5);
    gl.uniformMatrix4fv(this.u_ModelMatLoc, false, this.ModelMat.elements);
      this.mvpMatrix.setPerspective(40,vpa,1.0,1000.0);
      this.mvpMatrix.lookAt(cameraX,cameraY,cameraZ,
              lookX,lookY,lookZ,
    ...
    this.ModelMat.translate(0,1,0);
    //this.ModelMat.translate(0,0,boxX);
    this.ModelMat.rotate(g_angle03,-0.9375,0.0,0.5);
    gl.uniformMatrix4fv(this.u_ModelMatLoc, false, this.ModelMat.elements);
      this.mvpMatrix.setPerspective(40,vpa,1.0,1000.0);
      this.mvpMatrix.lookAt(cameraX,cameraY,cameraZ,
              lookX,lookY,lookZ,
      ...
      this.normalMatrix.transpose();
      gl.uniformMatrix4fv(this.u_NormalMatrixLoc, false, this.normalMatrix.elements);
      gl.drawArrays(gl.TRIANGLES,78,24);
    //	
  ...
  // Gouraud + Blinn Phong
    ...
    // sphere from one triangle strip.
      ...
      fullSat = new Float32Array(sat.length + sat2.length);
      fullSat.set(sat);
      fullSat.set(sat2,sat.length);
    
      this.vboContents = fullSat;
      this.vboVerts = fullSat.length/7;						// # of vertices held in 'vboContents' array
      this.FSIZE = this.vboContents.BYTES_PER_ELEMENT;
                                    // bytes req'd by 1 vboContents array element;
                                    // (why? used to compute stride and offset 
                                    // in bytes for vertexAttribPointer() calls)
    ...
    VBObox5.prototype.adjust = function(vpa) {
    //==============================================================================
    // Update the GPU to newer, current values we now store for 'uniform' vars on 
    // the GPU; and (if needed) update each attribute's stride and offset in VBO.
      ...
      gl.uniform3f(this.u_Lamp0Diff, 1.0, 1.0, 1.0);		// diffuse
      gl.uniform3f(this.u_Lamp0Pos, -2, 5, 0.5, 1.0);
      gl.uniform3f(this.u_Lamp0Amb,  0.4, 0.4, 0.4);	
      gl.uniform3f(this.u_Lamp0Spec,  1, 1, 1);	

      gl.uniform3f(this.u_Ke, 0.1, 0.1, 0.1);				// Ke emissive
      //gl.uniform3f(this.u_Ke, 0.5, 0.5, 0.5);				// Ke emissive
      gl.uniform3f(this.u_Ka, 0.3, 0.4, 0.9);				// Ka ambient
      gl.uniform3f(this.u_Kd, 0.5, 0.9, 0.8);				// Kd	diffuse
      gl.uniform3f(this.u_Ks, 0.0, 0.0, 1.0);       // Ks	specular
    ...
    //
      ...
      this.ModelMat.setTranslate( 2, -3, 0);	
      ...
      gl.drawArrays(gl.TRIANGLES, 0, sat.length/7);
      
      this.ModelMat.rotate(90, 0, 0, 1); 
      this.ModelMat.translate(0.05,-0.05,0.02)
      this.ModelMat.rotate(g_angle01, 1, 0, 0); 
      gl.uniformMatrix4fv(this.u_ModelMatLoc, false, this.ModelMat.elements);
        this.mvpMatrix.setPerspective(40,vpa,1.0,1000.0);
      this.mvpMatrix.lookAt(cameraX,cameraY,cameraZ,
              lookX,lookY,lookZ,
      ...
      gl.drawArrays(gl.TRIANGLES, sat.length/7, sat2.length/7);
      
      pushMatrix(this.ModelMat);
      this.ModelMat.rotate(180,0,0)
      this.ModelMat.translate(-tube3,0,0)
      this.ModelMat.rotate(g_angle01, 1, 0, 0); 
      this.ModelMat.rotate(g_angle01, 1, 0, 0); 
      gl.uniformMatrix4fv(this.u_ModelMatLoc, false, this.ModelMat.elements);
        this.mvpMatrix.setPerspective(40,vpa,1.0,1000.0);
      ...
      this.ModelMat.translate(0,tube4,0)
      this.ModelMat.rotate(g_angle01, 1, 0, 0); 
      gl.uniformMatrix4fv(this.u_ModelMatLoc, false, this.ModelMat.elements);
        this.mvpMatrix.setPerspective(40,vpa,1.0,1000.0);
      this.mvpMatrix.lookAt(cameraX,cameraY,cameraZ,
      ...
      this.ModelMat.translate(0,tube2,0)
      this.ModelMat.rotate(g_angle01, 1, 0, 0); 
      gl.uniformMatrix4fv(this.u_ModelMatLoc, false, this.ModelMat.elements);
        this.mvpMatrix.setPerspective(40,vpa,1.0,1000.0);
      this.mvpMatrix.lookAt(cameraX,cameraY,cameraZ,
    ...
    /*
    VBObox5.prototype.empty = function() {
    //=============================================================================
    // Remove/release all GPU resources used by this VBObox object, including any 
    // shader programs, attributes, uniforms, textures, samplers or other claims on 
    // GPU memory.  However, make sure this step is reversible by a call to 
    ...
    VBObox5.prototype.restore = function() {
    //=============================================================================
    // Replace/restore all GPU resources used by this VBObox object, including any 
    // shader programs, attributes, uniforms, textures, samplers or other claims on 
    // GPU memory.  Use our retained Float32Array data, all values for  uniforms, 
