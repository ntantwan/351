...
// the GPU; and (if needed) update each attribute's stride and offset in VBO.
  ...
  this.mvpMatrix.setPerspective(42,1.0,1.0,1000.0);
...
function VBObox1() {
  ...
  // the GPU; and (if needed) update each attribute's stride and offset in VBO.
    ...
    // Adjust values for our uniforms,
    this.ModelMat.setPerspective(42,1.0,1.0,1000.0);
...
//
this.ModelMat.setTranslate(7.0,-0.5,1.0);
...
this.ModelMat.rotate(270,1,0,0);
...
//
	...
	this.ModelMat.setTranslate( 2, -1, 0);	
