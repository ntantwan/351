...
//	'  vec3 normal = v_Normal; \n' +
	...
	'  float nDotL = max(dot(lightDirection, normal), 0.0); \n' +
      ...
      // H = normalize(normalize(v_Normal) + normalize(lightDirection)) 
      // H = normalize(normalize(V) + normalize(L)) 
...
//		 || !u_Ks || !u_Kshiny
  ...
  gl.uniform3f(u_Ka, 1.0, 1.0, 1.0);				// Ka ambient
